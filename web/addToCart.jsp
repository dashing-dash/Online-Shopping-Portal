        ...
        <div class="container_16">
            <div class="grid_16" id="whiteBox">
                <div class="grid_8 push_3" >
                    ...
                    %>
                    <a href="_newLogin.jsp"> <h3 class="showForm" id="loginBtn" style="padding:10px 00px">Please Login before buying...</h3></a>
                    ...
                    <%
                        ...
                        if (request.getParameter("id") == null) {
                            ...
                            if (b == true) {
                                out.println("id="+id + " " + cart.getProductName(id) + " added !! with price of " + cart.getProductPrice(id));
                            } else {
